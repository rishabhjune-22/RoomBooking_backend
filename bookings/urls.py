...
from .views import (
    ...
    BookingCreateView,
    BookingCreateMailTemplateView,
    BookingBulkMailTemplateView,
...
urlpatterns = [
    ...
    path(
        "bookings/create-mail-template/",
        BookingCreateMailTemplateView.as_view(),
        name="booking-create-mail-template",
    ),
    path("bookings/", BookingListView.as_view(), name="booking-list"),
    path("bookings/mail-template/", BookingBulkMailTemplateView.as_view(), name="booking-mail-template-bulk"),
    ...
    path("bookings/<int:pk>/mail-template/", BookingMailTemplateView.as_view(), name="booking-mail-template"),
